...
function doesPass(string){
	const regex = /(code)|(wars)|[^\sa-zA-Z]/gi
	return string.match(regex)
}


console.log(doesPass("Codewars is a great place to find a great code"))		// ["Codewars", "is", "a", "great", "place", "to", "find", "a", great"]
console.log(doesPass( "There are no sym!bols bet@ween us!"))			// ["There", "are", "no", "sym", "bols", "bet", "ween", "us"]