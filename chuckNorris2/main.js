...
function onePunch(items){return typeof items !== 'string' ? 'Broken!' : items.split(' ').sort((a, b) => a.toLowerCase() < b.toLowerCase() ? -1 : a.toLowerCase() > b.toLowerCase() ? 1 : 0).join(' ').replace(/[ae]/gi, '')}



console.log(onePunch(4321))						// 'Broken!'
